...
module.exports = expression => {
  ...
  function add(type, value) {
    ...
    if ((type === 'chord' || type === 'scale' || type === 'progression') && typeof value === 'string') {
      // FIXME: how to operate 2nd arg for progression?
      item.value = scribble[type](value.replace(RE_TRIM, ''));
